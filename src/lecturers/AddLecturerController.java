...
public class AddLecturerController implements Initializable {
    ...
    public void addLecturer(ActionEvent actionEvent) {
        ...
        }else if(nat_ID1.getText().length()<8 || nat_ID1.getText().length()>8) {
        	JOptionPane.showMessageDialog(null,"Invalid National ID, enter a Valid ID please");
        } else if (!isInt(nat_ID1)) {
            alertUser(nat_ID1);
