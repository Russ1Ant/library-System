...
public class Controller<LibrayStaff> implements Initializable{
	 ...
	 @FXML
	  ...
	  // 	
	    ...
	    void studentsMenu(ActionEvent event) throws IOException {
	        ...
	        Parent root = FXMLLoader.load(getClass().getResource("/studentsPackage/view.fxml"));
	 	    Scene scene = new Scene(root,1200,720);
	    ...
	    void lecturersMenu(ActionEvent event) throws IOException {
	    	 ...
	    	 Parent root = FXMLLoader.load(getClass().getResource("/lecturers/view.fxml"));
		 	    Scene scene = new Scene(root,1200,720);
	    ...
	    void issiueBook(ActionEvent event) throws SQLException {
	    	...
	    	String sqlb = "select * from BOOKS where ISBN = '"+bookSearchTextField.getText()+"'";
	         String sqlS = "select * from students where reg_no = '"+studentID+"' and Student_status ='in_session'";
	    ...
	    void searchBorrowerToIssiueBook(ActionEvent event) {
	    	...
	    	if(borrowerTextField.getText().isEmpty()) {
	    		...
	    		try {
	    		Connection conn = db.getConnection();
	    		String sql = "Select * from students where reg_no = '" +borrowerTextField.getText()+"' and Student_status = 'in_session'";
	    		ResultSet rs = conn.prepareStatement(sql).executeQuery();
	    		if(rs.next()) {
